...
export default function Projects() {
  return (
    <section className="ml-2 bg-gray-300 w-1/3 rounded-lg my-2 py-2 px-2 border border-gray-400">
      <h2
        className="text-4xl bg-gray-400 my-2 mx-1 rounded-lg border border-gray-500 px-2 py-2"
        key="projectHeader"
      >
        Projekt 1
      </h2>
      <h3
        className="text-2xl my-2 bg-gray-400 mx-1 rounded-lg border border-gray-500 px-2 py-2"
        key="todoHeader"
      >
        Todo list
      </h3>
      <div
        className="text-lg bg-gray-400 flex flex-col mx-1 rounded-lg border border-gray-500 px-2 py-2"
        key="todos"
      >
      ...
      <div
        ...
        key="people"
      >
        <h2 className="text-2xl" key="peopleHeader">
          People involved
        </h2>
