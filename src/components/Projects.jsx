...
export default function Projects() {
  return (
    <section className="ml-2 bg-gray-300 w-1/3 rounded-lg my-2 py-2 px-2 border border-gray-400">
      <h2 className="text-4xl bg-gray-400 my-2 mx-1 rounded-lg border border-gray-500 px-2 py-2">
        Projekt 1
      </h2>
      <h3 className="text-2xl my-2 bg-gray-400 mx-1 rounded-lg border border-gray-500 px-2 py-2">
        Todo list
      </h3>
